...
function Ojos({ agregarAlCarrito, toggleCarrito }) {
  return (
    <div className="productos">
      ...
      <div className="frase">
        <p>"El alma que puede hablar con los ojos también puede besar con la mirada" - Gustavo Adolfo Bécquer</p>
      </div>

      <CarritoOjos agregarAlCarrito={agregarAlCarrito} toggleCarrito={toggleCarrito} />
    </div>
  );
}
